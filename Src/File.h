...
class File
{
	public:
		...
		// Create shared file
		bool createSharedFile(const std::string& _strFilename, int _iShareMode, bool _bBinary = false, bool _bAppend = false);
		bool createSharedFile(const std::wstring& _strFilename, int _iShareMode, bool _bBinary = false, bool _bAppend = false);
		...
		static std::wstring getFilenameFromPath(const std::wstring& _strPath);
		...
		// Get time date
		static std::string getDateTime(const std::string& _strPath);
		static std::wstring getDateTime(const std::wstring& _strPath);
		...
		static void removeDirectorySeparator(std::string& _strPath);
		static void removeDirectorySeparator(std::wstring& _strPath);
		...
		// Get safe filename
		static bool getSafeFilename(std::string& _strPath);
		static bool getSafeFilename(std::wstring& _strPath);
